...
My research focuses on generative AI for production environments, with an emphasis on diffusion models, score-based and flow-based generation, MeanFlow, multimodal controlled generation for image and sound, efficient adaptation, and high-fidelity generative systems that can move from research prototypes to real production settings.

My academic path has taken me across ESME in France, HGU University in South Korea, and ÉTS in Canada, shaping my profile at the intersection of engineering, applied AI, and scientific research.

I believe in the strength of AI as a tool to enhance work efficiency and human experience, support creative and scientific workflows, and push human limits through science.

## Research Interests

My research interests lie at the intersection of generative modeling, multimodal learning, and efficient adaptation. I am particularly interested in diffusion models, score-based models, flow matching and MeanFlow, with a focus on improving controllability, efficiency, and generation quality.
...
- Email: [melodie.desbos@livia.etsmtl.ca](mailto:melodie.desbos@livia.etsmtl.ca)
- GitHub: [meluxis](https://github.com/meluxis)
- Google Scholar: [Mélodie Desbos](https://scholar.google.com/citations?user=sANOdsQAAAAJ&hl=fr&oi=sra)
- LinkedIn: [Mélodie Desbos](https://ca.linkedin.com/in/m%C3%A9lodie-desbos)
- CV: [Download PDF](/files/CV_MelodieDesbos.pdf)
